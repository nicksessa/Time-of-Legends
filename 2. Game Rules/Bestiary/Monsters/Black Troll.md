...
name: Black Troll
image: z_Assets/Images/troll_01.jpg
char-name: Black Troll
statblock: true
level: 9
type: Creature
rank: Goblin Creature
virtue-level: 1
divine-favor: 0
wounds: Light
MOVE: Long
...
> [!recite]- Troll
> ![[troll_01.jpg|right|175]]
>  
> | M | I | ATT | S  | DEF | DR | AIM | COU | DIS | A |
> |:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
> | L | 1 | 5   | 15 | 3   | 14 | 0   | 9   | 0   | 2 | 
> 
> Troop Type: Creature
> Equipment: 
> Special Rules: Fear, Regeneration (5+), Stupid
...
| Wound Level  | `INPUT[inlineSelect(option(None), option(Shock), option(Light), option(Serious), option(Critical), option(Dead)):wounds]`    |
| --- | --- |
...
> | STR | `INPUT[inlineSelect(option(0), option(1), option(2), option(3), option(4), option(5), option(6), option(7), option(8), option(9), option(10), option(11), option(12), option(13), option(14), option(15), option(16), option(17), option(18), option(19), option(20)):STR]` |
...
> |COU | `INPUT[inlineSelect(option(0), option(1), option(2), option(3), option(4), option(5), option(6), option(7), option(8), option(9), option(10), option(-1), option(-2), option(-3), option(-4), option(-5), option(-6), option(-7), option(-8), option(-9), option(-10)):COU]` |
