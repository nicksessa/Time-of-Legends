...
| Equipment                                                    | Stock | Cost (Buy) | Cost (Sell) | Num Available |
| ------------------------------------------------------------ |:-----:| ---------- | ----------- |:-------------:|
| Boots                                                        |   4   | 20         | 10          |       -       |
| Fine Robes                                                   |   6   | 50         | 20          |       -       |
| [[General Store#Bandages\|Bandages]]                         |   5   | 50 Each    | 5           |      1D6      |
| [[General Store#Bear Trap\|Bear Trap]]                       |   6   | 100        | 5           |      1d3      |
| [[General Store#Casks of Beer\|Casks of Beer]]               |   5   | 50 Each    | -           |      1d6      |
| [[General Store#Church Candles\|Church Candles]]             |   3   | 10 Each    | -           |      1d3      |
| [[General Store#Compass\|Compass]]                           |  11   | 500        | 30          |       1       |
| [[General Store#Door Spikes\|Door Spikes]]                   |   7   | 100 Each   | 10          |      1d6      |
| [[General Store#Fishing Net\|Fishing Net]]                   |   5   | 100        | 5           |      1d3      |
| [[General Store#Food Rations\|Food Rations]]                 |   5   | 1 Each     | -           |      3D6      |
| [[General Store#Heavy Cloak\|Heavy Cloak]]                   |   5   | 300        | 75          |      1d3      |
| [[General Store#Iron Rations\|Iron Rations]]                 |   9   | 75 Each    | 5           |      2d6      |
| [[General Store#Lantern Oil\|Lantern Oil]]                   |   3   | 50         | -           |      2d6      |
| [[General Store#Lantern\|Lantern]]                           |   6   | 250        | 10          |      1d6      |
...
| [[General Store#Rope\|Rope]]                                 |   5   | 30         | 5           |      1d6      |
| [[General Store#Salt\|Salt]]                                 |   4   | 50         | 5           |      2d6      |
| [[General Store#Salted-Meat\|Salted-Meat]]                   |   6   | 60 Each    | -           |      2d6      |
| [[General Store#Small Game Trap\|Small Game Trap]]           |   5   | 100        | 10          |      1d3      |
| [[General Store#Storm Lantern\|Storm Lantern]]               |   8   | 500        | 50          |      1d3      |
| [[General Store#Ten Foot Pole\|Ten Foot Pole]]               |   5   | 40         | 5           |      1d3      |
| [[General Store#Torches\|Torches]]                           |   4   | 25 Each.   | -           |      1d6      |
...
Each bandage restores 1 Wound Level. They are single use items.  Bandages are perishable.  At the end of each adventure roll 1D6 for each unused bandage. On a score of 1, 2 or 3 the bandage has perished and is of no further use.  If stored in an oilcloth or waxcloth satchel, the bandage is only destroyed on a 1.
...
Each Church Candle burns for 1d6 + 6 turns or 6 rooms, whichever is more.  Candles light the current Board Section only but may be used to explore just like the Lantern.

## Compass

It is difficult to find a compass away from the great Sea Ports of the Old World. This allows the party to navigate better in the wilds. For any wilderness travel, you may reduce the journey time by D3 weeks.  Any "Lost" results on any table can be rerolled.

## Door Spikes

Each spike keeps a door shut for one turn. To use spike your Warrior must be adjacent to the door. Once spiked, a door cannot be opened unless it is broken down. To break down a door, a Monster must be adjacent to the door. Roll a die and add the Monster's Strength. On a score of 9 or more the Monster breaks down the door.

## Fishing Net

May only be used to trap Monsters that are human-sized or smaller, for example Dark Elves, Giant Spiders, Chaos Warriors but not Ogres, Minotaurs, Dragons, Centaurs and so on. Instead of attacking, the user may elect to make a single roll To Hit with a -1 To Hit penalty in combat against an adjacent Monster. A successful hit indicates that the Monster is Webbed (see the rules for Giant Spiders). The Monster may make a Strength Test to escape each turn as described in the Giant Spider rules. If they manage to escape, the net is destroyed and may not be used again.  If the user misses, then the net may be reclaimed at the end of the Combat when there are no more Monsters on the board section.

## Food Rations
Every day each warrior must consume 1 Food Ration.  Warriors lose one point of INI, STR or T every day that they do not eat.  You can roll randomly below or chose which stat is affected.  If any stat goes below zero, the warrior will collapse.  Once the warrior is able to eat again, reduced stats will recover 1d2 points per day. Warriors can carry up to 10 rations.  After each adventure, roll a 1d6 for each Ration.  On a 1, 2 or 3, the food has been spoiled and must be discarded.
...
For each week that reveals an Uneventful Week Travelling Hazard when travelling to a Settlement, roll 1d6 for every trap that you decide to use. On a natural 1, the trap malfunctions and must be discarded. On a 2-3, you don't catch anything this time. On a 4+ you catch enough meat to be preserved as 1d3+1 Food Rations. These rations will not go bad until the end of the next Adventure.

## Heavy Cloak

Same as furs, but will not reduce the movement or hit rolls and may be worn in conjunction with furs.
...
The Lantern illuminates the Board Section the wielder is in, plus all adjoining Board Sections. If a Warrior moves onto a section of the Board that is not illuminated by the Lantern, or is left behind by the Leader, he becomes lost in the dismal depths of the Dungeon and is removed from the game.

Without a light source in a dungeon, all warriors have a 50% miss chance in melee and ranged weapons are useless.  All traps hit automatically and no saves are allowed.

## Lantern Oil
Enough Lantern Oil to last one Adventure.
...
If using travel as per Knights of Camelot, this item will allow the party to move one additional area per turn if a successful roll is made.  If the roll fails, move the party to a random adjacent area.

## Oilcloth Satchel
This waterproof leather bag can hold up to 10 bandages.  Bandages protected this way are only destroyed on a 1 after the adventure is over.

## Portable Spit

Whenever fresh provisions are being prepared by your Warrior, for example as part of the _Game_ Travelling Hazard, a portable spit roast can be used with salt and other preservatives to preserve the results for even longer. Instead of producing standard Provisions, Iron Rations are produced instead - see the rules for Salt-Meat here at The General Store.
...
Use to escape from pit traps.  After each use roll 1D6, on 1 or 2 the rope breaks and is discarded.  Rope also gives +1 to Climbing Checks. 

## Salt

Salt may be used whenever fresh provisions are being prepared by your Warrior, for example as part of the _Game_ Travelling Hazard. Salt and other preservatives may be used to preserve the Provisions you have prepared for longer. Instead of producing standard Provisions, Salt-Meat is produced instead - see the rules for Salt-Meat here at The General Store.

## Salted-Meat

As Food Rations.  However, only goes bad at the end of an Adventure on the roll of a 1 or 2.

## Storm Lantern

As described by the Barbarian's starting Equipment Card.  Requires Lantern Oil. If the Storm Lantern is blown out for any reason (like a Dungeon Event), then roll 1d6.  Due to its construction, a Storm Lantern will remain lit on a 3+.
