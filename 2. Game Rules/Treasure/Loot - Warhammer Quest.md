...
Commodities: 
`dice: [[Loot - Warhammer Quest#^treasureCommodities]]`

Potions: 
`dice: [[Loot - Warhammer Quest#^treasurePotionsAndTrinkets]]`

One Use Magic Items: 
`dice: [[Loot - Warhammer Quest#^treasureOneUseMagicItems]]`

Other Minor Magic Items: 
`dice: [[Loot - Warhammer Quest#^treasureOtherMinorItems]]`

Jewelry: 
`dice: [[Loot - Warhammer Quest#^treasureJewelry]]`

Armor and Shields: 
`dice: [[Loot - Warhammer Quest#^treasureArmorAndShields]]`

Weapons (Swords): 
`dice: [[Loot - Warhammer Quest#^treasureSwords]]`

Weapons (Other): 
`dice: [[Loot - Warhammer Quest#^treasureOtherWeapons]]`

Objective Room Magic Items: 
`dice: [[Loot - Warhammer Quest#^objectiveRoomMagicItems]]`

Objective Room Weapons and Armor: 
`dice: [[Loot - Warhammer Quest#^objectiveRoomWeaponsAndArmor]]`
%%
...
|                                                     | 
| --------------------------------------------------- |
| `dice: [[Loot - Warhammer Quest#^masterLootTable]]` |


## MASTER DUNGEON ROOM TREASURE CHART

| dice: 1D6 | RESULT OF ROLL |
| :---: |---|
| 1-2 | Valuables - `dice: [[Loot - Warhammer Quest#^valuablesSubTable]]` |  
| 3-4 | Magic Items. - `dice: [[Loot - Warhammer Quest#^magicItemsSubTable]]` |  
| 5-6 | Weapons and Armor. - `dice: [[Loot - Warhammer Quest#^weaponsAndArmorSubTable]]` |  
^masterLootTable
...
| dice: 1D6 | RESULT OF ROLL |
| :---: | --- |
| 1-3 | Gold - Roll as many D6 as desired, and multiply the total by (10 x Dungeon Level).  However, if any 1's are rolled on the dice, nothing is found. |  
| 4-6 | Commodities - `dice: [[Loot - Warhammer Quest#^treasureCommodities]]` |  
^valuablesSubTable
...
| :---: | --------------------------------------- |
| 1   | *Scroll                                 | 
| 2   | `dice: [[Loot - Warhammer Quest#^treasurePotionsAndTrinkets]]`              |
| 3   | `dice: [[Loot - Warhammer Quest#^treasureOneUseMagicItems]]`         |
| 4   | `dice: [[Loot - Warhammer Quest#^treasureOtherMinorItems]]`                 |
| 5   | `dice: [[Loot - Warhammer Quest#^treasureJewelry]]`                           |
...
| dice: 2D6 | RESULT OF ROLL |
|: ---: | --- |
| 2-5 | `dice: [[Loot - Warhammer Quest#^treasureArmorAndShields]]` |
| 6-8 | `dice: [[Loot - Warhammer Quest#^treasureSwords]]` |
| 9-12 | `dice: [[Loot - Warhammer Quest#^treasureOtherWeapons]]` |
^weaponsAndArmorSubTable

## MASTER OBJECTIVE ROOM TREASURE TABLE

| dice: 1D6 | RESULT OF ROLL |
|---|---|
| 1-3 | `dice: [[Loot - Warhammer Quest#^objectiveRoomMagicItems]]` |
| 4-6 | `dice: [[Loot - Warhammer Quest#^objectiveRoomWeaponsAndArmor]]` |
^objectiveRoomSubTable
...
| 24 | Holy Relic | At a church, the priests will pay D6x100 gold for the relic, but if a 1 is rolled, they give you nothing here. Another church in another area may buy it.  Relics can be used to reroll failed Virtue Tests but only if they are real.  Roll a d6, on a 4+ it's real. | var |
...
| 66 | Treasure Map | A partially destroyed map that indicates great treasure.  As each room is entered, roll a D6: 1-5 = not the treasure room, 6 = The treasure horde is hidden here.  After all encounters are dealt with, the Warriors discover a treasure horde, roll 3 times on the Treasure Chart, and resolve an event card immediately upon looting it. |Var |  
^treasureCommodities
...
| 14 | Sword of Battle | +1 Attack | 300 |
...
| 24 | Blessed Sword | Always hits on a 2+ | 500 |
| 25 | Venom Sword | In addition to normal damage, it inflicts d3 [[Combat#Poisoned Wounds\|poisoned wounds]]. | 400 |
...
| 31 | Enchanted Greatsword | 2-Handed weapon, +5 STR, -1 initiative. | 400 |
...
| 45 | Death Sword | Once per adventure: Increase STR to 10 for one turn | 250 |
