...
## And One More Thing...
If killed, make one free attack before being removed.
...
## Born Killer
Figures with this skill gain an immediate free attack when they kill or KO an opponent.

## Brave
Figures with this skill do not automatically fail when rolling a ONE on a Courage test.
...
When a figure with this ability charges, his STR becomes 10 for that combat round.

## Charging Strength (12)
When a figure with this ability charges, his STR becomes 12 for that combat round.

## Charging Strength (15)
When a figure with this ability charges, his STR becomes 15 for that combat round.
...
## Evade
A charged figure with this ability, who has not acted yet in this turn, may move away from the charging attacker. The attacker may still catch this figure if they have enough movement.
...
## Ferocious
Instead of inflicting a 'Stun', cause a Light Wound.
...
## Heroic
Each time this figure defeats an opponent in Melee, all allies within 6 inches gain +1 Morale.

## Holy Order
Once per game, may reroll any Attack roll or Defense roll.

## Hunter
May deploy hidden in a piece of area terrain at the start of battle.

## Horseman [0] - Untrained
...
## Inspiring
Allies within 6 inches gain +1 ATT and +1 DEF.

## It’s Just a Flesh Wound!
Ignore the negative effects of wounds.
...
## Resolve[X]
At any time, once per round, you may increase by [X] points INI, ATT, DEF or MORALE.

## Robust
This Captain has one extra wound level.
...
## Skirmisher
Opponent archers have an additional -1 to hit skirmishers. Models with this ability can Fire, then run.

## Sprinter
A figure with this ability can triple move.

## Stealth [X]
Ability to sneak and hide. The X value is the target number needed to spot a hidden character. Example: Stealth [6] would require an observer to roll a 6 on a d6 to spot the stealthy character. Additionally, after deployment you can make a move action before the game starts.

## Stealthy
After deployment, you can make a move action before the game starts.

## Strong as an Ox
Opponent has a -1 penalty to DR or Toughness
...
## Veteran
Ignore Morale penalties when making Morale checks.
