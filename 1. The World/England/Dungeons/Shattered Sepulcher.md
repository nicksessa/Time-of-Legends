...
---
id: ShatteredSepulcher_001
image: [[shattered_sepulcher_of_the_red_prince.png]]   

Source: https://watabou.github.io/dungeon.html
...
```leaflet  
id: ShatteredSepulcher_001 ### Must be unique with no spaces  
image: [[shattered_sepulcher_of_the_red_prince.png]] ### Link to the map image file. Do not add a ! in front of the image  
bounds: [[0,0], [3083, 5441]] ### Size of the map in px Height_y, Width_x. Ignore 0,0  
height: 850px ### Size of the leaflet embed in px on your screen  
width: 95% ### Size of the leaflet embed in your note  
lat: 1500 ### To center the map, make this half of the map height.  
long: 2700 ### To center the map, make this half of the map width.  
