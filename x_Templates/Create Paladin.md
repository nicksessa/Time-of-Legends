...
| ---- |:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:-------:|
| Paladin |  3  |  4  |  3/5  |  3/5  |  3/9/12  |  0  |  8  |  3  | `INPUT[inlineSelect(option(None), option(Shock), option(Light), option(Serious), option(Critical), option(Dead))]` |

| Armor                | Weapons            | Shield        |
| -------------------- | ------------------ | ------------- |
| Partial Plate - DR 6 | Hand Weapon, Lance | Medium Shield |
